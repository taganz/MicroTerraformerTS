...
import {Creature, ThrophicLevel, LifeParameters, AttackResult, colorEqual} from "./Creature.js"    // .js perque si no no ho posa al .js
...
//                this.drawPixel(x,y, 0, 0, 0, 255);
    ...
    iterationCheckNeighbour(joe: LifeParameters, x1: number, y1:number, x2:number, y2:number):boolean {
